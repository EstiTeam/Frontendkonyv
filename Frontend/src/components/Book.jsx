        ...
        <div>
          ...
          <p
            className={`text-gray-600 flex items-center ${
              book.elerheto ? 'text-green-500' : 'text-red-500'
            }`}
          >
            {book.elerheto ? (
              <>
          ...
          {isLoggedIn && (
            <>
              <button
                ...
                className={`${
                  book.elerheto ? 'bg-green-500 hover:bg-green-600' : 'bg-red-500 hover:bg-red-600'
                } text-white font-semibold py-2 px-4 rounded shadow-lg transition duration-300`}
              >
                {book.elerheto ? 'Kölcsönzés' : 'Visszahozta'}
              </button>
              <button className="btn btn-active btn-accent bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-2 px-4 rounded shadow-lg hover:shadow-xl transition duration-300">
                Módosítás
              </button>
              <button className="btn btn-active btn-error bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded shadow-lg hover:shadow-xl transition duration-300">
                Törlés
              </button>
            </>
          )}
